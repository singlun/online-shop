<?php
	...
	if (isset($_REQUEST['chk_item_id'])) {
		echo $_SESSION['mode'] . " testing";
		if ($_REQUEST['mode'] == 'I') {
				$chk_sql = "INSERT INTO order_info (u_id, chk_item, chk_qty, chk_ref, order_date  ) VALUES  (" . $_SESSION[u_id] . ", " . $_REQUEST[chk_item_id] . ", 1 , '" . $_SESSION[ref] . "', '" . $_SESSION[date] . "')";
		...
		if ($_REQUEST['mode'] == 'U') {
				$chk_sql = "Update order_info set chk_qty = $_SESSION[chk_qty] where u_id = '".$_SESSION['u_id']."' and chk_ref = '".$_SESSION['ref']."' and chk_item =".$_REQUEST['chk_item_id'];
				$chk_run = mysqli_query($conn, $chk_sql);
				//$_SESSION['mode'] = "'L'";
				$_SESSION['chk_qty'] = 0;
				//echo $chk_sql;						
		...
		if ($_REQUEST['mode'] == 'C') {
			$chk_sql = "INSERT INTO checkout SELECT u_id, chk_id, chk_ref, chk_item, chk_qty, chk_timing FROM order_info where u_id = ".$_SESSION['u_id']." and chk_ref = '".$_SESSION['ref']."'";	
